        ...
        <section>
            <div class="container">
                ...
                <div class="col">
                        ...
                        <h1>Sistema para Venta de Artículos</h1>
                        <ul >
                            ...
                            <li class="nav-item">
                                <a style=" background-color: #53b124;  border-color: #53b124; color: #fff;" class="nav-link active" href="listado_usuarios.php">Listado Usuarios</a> <br>
                            </li>

                            <li class="nav-item">
                                <a style=" background-color: #53b124;  border-color: #53b124; color: #fff;"  class="nav-link active" href="pedidos_de_usuarios.php">Pedidos de Usuarios</a> <br>
                            </li>
